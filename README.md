...
* Disabled the audio engine on fullscreen app so the computer will go into sleep mode.
* When launching a game in fullscreen mode, move the mouse cursor to the top right corner of the screen.
